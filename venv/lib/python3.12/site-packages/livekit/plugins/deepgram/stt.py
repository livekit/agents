...
class STT(stt.STT):
    def __init__(
        ...
        *,
        ...
        logging.info(f"Initialized STT with options: {self._config}")
    ...
    async def recognize(
        ...
        *,
        ...
        logging.info("QUERY_PARAMSSSSS: " + str(query_params))
    ...
    def stream(
        ...
        *,
        ...
        print(f"Created SpeechStream with config: {config}")
        return stream
...
class SpeechStream(stt.SpeechStream):
    ...
    async def _try_connect(
        ...
        logging.info("queeeryyyy paramssss:" + str(query_params))
