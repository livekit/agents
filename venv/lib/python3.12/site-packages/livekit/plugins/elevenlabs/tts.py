...
class SynthesizeStream(tts.SynthesizeStream):
    ...
    def _stream_url(self) -> str:
        ...
        model_id = self._config.model_id
        return f"{base_url}/text-to-speech/{voice_id}/stream-input?model_id={model_id}&output_format=mp3_{self._config.sample_rate}_32&optimize_streaming_latency={self._config.latency}"
