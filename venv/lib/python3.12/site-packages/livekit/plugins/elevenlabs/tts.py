    ...
    async def synthesize(
        ...
        *,
        ...
        async with self._session.post(
            f"{self._config.base_url}/text-to-speech/{voice.id}?output_format=ulaw_{self._config.sample_rate}",
            headers={AUTHORIZATION_HEADER: self._config.api_key},
            json=dict(
                text=text,
...
class SynthesizeStream(tts.SynthesizeStream):
    ...
    def _stream_url(self) -> str:
        ...
        model_id = self._config.model_id
        return f"{base_url}/text-to-speech/{voice_id}/stream-input?model_id={model_id}&output_format=ulaw_{self._config.sample_rate}&optimize_streaming_latency={self._config.latency}"
