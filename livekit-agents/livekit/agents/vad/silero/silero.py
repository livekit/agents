...
try:
    ...
    logger.error("numpy and onnxruntime must be installed to use the Silero VAD, please install them using `pip install numpy onnxruntime`")
    raise ImportError
