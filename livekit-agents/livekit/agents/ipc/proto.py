...
class StartJobRequest:
    ...
    def write(self, b: io.BytesIO) -> None:
        ...
        channel.write_float(b, self.running_job.received_at)
        channel.write_float(b, self.running_job.accepted_at)
        channel.write_float(b, self.running_job.assigned_at)
        channel.write_float(b, self.running_job.launched_at)
    ...
    def read(self, b: io.BytesIO) -> None:
        ...
        self.running_job = RunningJobInfo(
            ...
            received_at=channel.read_float(b),
            accepted_at=channel.read_float(b),
            assigned_at=channel.read_float(b),
            launched_at=channel.read_float(b),
        )
