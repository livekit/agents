    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "options": {
                ...
                "interruption_guard_enabled": self.options.interruption_guard_enabled,
                "ignored_interruption_words": list(self.options.ignored_interruption_words),
                "filler_confidence_threshold": self.options.filler_confidence_threshold,
            },
