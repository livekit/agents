...
CONVERSATIONAL_EXPRESSIVENESS_PRESET: ExpressivenessOptions = ExpressivenessOptions(
    tts_instructions_template=Instructions(
        ...
        '- Occasionally, when it genuinely fits, clear your throat (<sound value="clear throat"/>) '
        "before launching into something or shifting topic, or let a small <sound value=\"cough\"/> "
        "slip in mid-thought. These add realism but are easy to overdo — reach for them only "
        "every so often, never on back-to-back turns.\n"
        ...
        'vary pitch (bright vs. grounded) and volume ("full-voiced", "soft and intimate", "drop to '
        'a whisper") so no two turns sound the same.\n'
