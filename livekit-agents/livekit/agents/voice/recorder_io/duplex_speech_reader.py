...
class DuplexSpeechReader(RecorderIO):
    def __init__(
        self,
        *,
        ...
        self._in_record: DuplexSpeechReaderAudioInput | None = None
        self._out_record: DuplexSpeechReaderAudioOutput | None = None
    ...
    @utils.log_exceptions(logger=logger)
    def record_input(self, audio_input: io.AudioInput) -> DuplexSpeechReaderAudioInput:
        self._in_record = DuplexSpeechReaderAudioInput(speech_reader=self, source=audio_input)
        return self._in_record

    @utils.log_exceptions(logger=logger)
    def record_output(self, audio_output: io.AudioOutput) -> DuplexSpeechReaderAudioOutput:
        self._out_record = DuplexSpeechReaderAudioOutput(
            speech_reader=self, audio_output=audio_output
        )
...
class DuplexSpeechReaderAudioInput(io.AudioInput):
    def __init__(self, *, speech_reader: DuplexSpeechReader, source: io.AudioInput) -> None:
        super().__init__(
            label="DuplexSpeechReaderAudioInput",
            source=source,
        )
        self.__label = "DuplexSpeechReaderAudioInput"
        self.__audio_input = source
        self.__reader = speech_reader
    ...
    async def __anext__(self) -> rtc.AudioFrame:
        ...
        if self._started_at is None:
            ...
            logger.info(f"User speech started at: {self._started_at}")

        if self.__reader.reading:
...
class DuplexSpeechReaderAudioOutput(io.AudioOutput):
    def __init__(
        self,
        *,
        speech_reader: DuplexSpeechReader,
        audio_output: io.AudioOutput | None = None,
    ) -> None:
        super().__init__(
            label="DuplexSpeechReaderAudioOutput",
