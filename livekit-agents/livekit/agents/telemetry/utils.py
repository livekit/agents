...
def record_realtime_metrics(span: trace.Span, ev: RealtimeModelMetrics) -> None:
    ...
    attrs: dict[str, str | int] = {
        ...
        trace_types.ATTR_LANGFUSE_UNCACHED_INPUT_TEXT_TOKENS: ev.input_token_details.text_tokens - ev.input_token_details.cached_tokens_details.text_tokens if ev.input_token_details.cached_tokens_details else 0,
        trace_types.ATTR_LANGFUSE_UNCACHED_INPUT_AUDIO_TOKENS: ev.input_token_details.audio_tokens - ev.input_token_details.cached_tokens_details.audio_tokens if ev.input_token_details.cached_tokens_details else 0,
