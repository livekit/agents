    ...
    def __init__(
        ...
        *,
        ...
        if self._info.text_request:
            from .text_job import TextMessageContext as _TextMessageContext

            self._text_message_context: TextMessageContext | None = _TextMessageContext(
                job_ctx=self, text_request=self._info.text_request
            )
        else:
            self._text_message_context = None
