        ...
        if not self.done():
            self.complete(
                ToolError(
                    ...
                    "toolset is back: continue with what the caller actually wants (a followup -> "
                    "record_followup). Nothing was booked or recorded during verification - don't "
                    "claim otherwise."
                )
            )
