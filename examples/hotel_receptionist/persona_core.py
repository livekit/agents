...
- concierge: tours, spa, flowers, the airport car, flight reconfirmation, business centre.
- guest_services: housekeeping and anything physical brought or fixed, wake-up calls, do-not-disturb, a message for a guest, stored preferences, and anything else you can't do yourself.
...
- policy: hotel or restaurant detail, terms, money, or conditions you can't answer outright.
