...
class ServicesToolsMixin(HotelAgent):
    ...
    async def schedule_wakeup_call(
        ...
        return (
            f"wake-up call set for {spoken}, {format_date(call_date)} at "
