...
class Messenger(AgentTask):
    def __init__(self) -> None:
        super().__init__(
            instructions="You are Shimmer, an assistant taking messages for the LiveKit dental office. Be sure to confirm details such as phone numbers with the user. Be brief and to the point.",
        )
