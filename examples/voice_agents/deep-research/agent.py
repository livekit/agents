    ...
    def __init__(self) -> None:
        super().__init__(
            instructions=(
                ...
                "- Forward the user's request with every constraint and instruction intact "
                "(e.g. 'just start, no clarifying questions', scope limits, deadlines) — "
                "never trim or reword them away.\n"
