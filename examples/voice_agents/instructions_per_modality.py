...
AUDIO_SPECIFIC = (
    ...
    "- Resolve relative spoken expressions to a concrete date/time: "
    "'next Tuesday', 'tomorrow afternoon', 'the week after next around 3'.\n"
    "- Spoken numbers may be ambiguous: 'three thirty' could mean 3:30 PM or the 30th of March — "
    "ask for clarification when context does not make it obvious.\n"
    "- Honor verbal self-corrections: if the user says 'wait, I meant Thursday not Tuesday', "
    "update your understanding to Thursday and discard Tuesday.\n"
    "- Ignore filler words and hesitations ('um', 'uh', 'like', 'I guess').\n"
    "- Always confirm the resolved date and time out loud before booking, "
    "since spoken input is inherently ambiguous.\n"
)
...
TEXT_SPECIFIC = (
    ...
    "- Accept exact dates and times in any common format (ISO, natural language, "
    "12-hour or 24-hour clock).\n"
    "- If the user provides a complete and unambiguous date and time, "
    "you may book immediately without asking for confirmation.\n"
