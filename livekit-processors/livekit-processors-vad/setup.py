...
about = {}
with open(os.path.join(here, 'livekit', 'processors', 'vad', 'version.py'), 'r') as f:
    exec(f.read(), about)


setuptools.setup(
    name="livekit-processors-vad",
    version=about['__version__'],
    description="LiveKit Python Processor for Voice Activity Detection",
