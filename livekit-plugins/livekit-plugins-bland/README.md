...
Voice agents can stream text through Bland's realtime WebSocket. Use `synthesize()` for complete strings over HTTP. See the [Bland realtime TTS reference](https://docs.bland.ai/api-v2/post/tts-ws).
