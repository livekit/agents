...
class WhisperOpenSourceTranscriberPlugin(core.STTPlugin):
    ...
    def process(self, frames_iterator: AsyncIterator[[rtc.AudioFrame]]) -> AsyncIterator[core.STTPluginEvent]:
        async def iterator():
    ...
    async def _push_frames(self, frames: [rtc.AudioFrame]) -> core.STTPluginEvent:
        resampled = [
