    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            tool_response_scheduling (FunctionResponseScheduling, optional): The scheduling for tool response. Defaults to INTERRUPT to ensure Gemini generates a response after tool execution in voice mode.
