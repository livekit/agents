...
class SpeechRecognition:
    def __init__(self, *, google_credentials_filepath: str):
        ...
        recognizer = (
            f"projects/{self._google_json['project_id']}/locations/global/recognizers/_"
        )
        ...
        self._result_iterator = core.AsyncQueueIterator(self._result_queue)

    def push_frames(
        self, frames: AsyncIterator[rtc.AudioFrame]
    ) -> AsyncIterator[core.STTPluginResult]:
