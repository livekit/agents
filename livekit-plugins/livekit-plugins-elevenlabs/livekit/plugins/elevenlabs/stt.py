...
class ElevenLabsSTTModels:
    ...
    id: Literal["scribe_v1", "scribe_v2", "scribe_v2_realtime"]
...
class STT(stt.STT):
    def __init__(
        ...
        *,
        ...
        if use_realtime and not "realtime" in model_id:
            logger.warning("The currently selected model is not a realtime model but use_realtime is True")
